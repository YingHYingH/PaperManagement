...
<body>
	...
	<div class="am-container">
		<h1 class="am-topbar-brand">
			<a href="landing.jsp">PaperManagement</a>
		</h1>
		...
		<div class="am-collapse am-topbar-collapse" id="collapse-head">
			<ul class="am-nav am-nav-pills am-topbar-nav">
				<li class="am-active"><a href="landing.jsp">Home</a></li>
			</ul>

			<div class="am-topbar-right">
				<!-- <button class="am-btn am-btn-secondary am-topbar-btn am-btn-sm">
					<span class="am-icon-pencil"></span> <a href="register.jsp">注册</a>
				</button> -->
				<a href="register.jsp"
					class="am-btn am-btn-secondary am-topbar-btn am-btn-sm am-icon-pencil">
					注册</a>
			</div>
			...
			<div class="am-topbar-right">
				...
				<a href="login.jsp"
					class="am-btn am-btn-primary am-topbar-btn am-btn-sm am-icon-user">
					登录</a>
	...
	<div class="get">
		<div class="am-g">
			<div class="am-u-lg-12">
				<h1 class="get-title">PaperManagement - 学术论文管理系统</h1>

				<p>期待你的使用，共同打造一个简单易用的论文管理系统</p>


				<p>
					<a href="register.jsp" class="am-btn am-btn-sm get-btn">注册帐号√</a>
				</p>
			</div>
		</div>
	</div>
				...
				<div class="am-g">
					<div class="am-u-lg-3 am-u-md-6 am-u-sm-12 detail-mb">
						...
						<p class="detail-p">Amaze UI 采用业内先进的 mobile first
							理念，从小屏逐步扩展到大屏，最终实现所有屏幕适配，适应移动互联潮流。</p>
					</div>
					<div class="am-u-lg-3 am-u-md-6 am-u-sm-12 detail-mb">
						<h3 class="detail-h3">
						...
						<p class="detail-p">Amaze UI 含近 20 个 CSS 组件、10 个 JS 组件，更有 17
							款包含近 60 个主题的 Widgets，可快速构建界面出色、体验优秀的跨屏页面，大幅度提升你的开发效率。</p>
					</div>
					<div class="am-u-lg-3 am-u-md-6 am-u-sm-12 detail-mb">
						<h3 class="detail-h3">
	...
	<div class="hope">
		<div class="am-g am-container">
			...
			<div class="am-u-lg-8 am-u-md-6 am-u-sm-12">
				...
				<p>在知识爆炸的年代，我们不愿成为知识的过客，拥抱开源文化，发挥社区的力量，参与到Amaze Ui开源项目能获得自我提升。</p>
			</div>
		</div>
	</div>
	...
	<footer class="footer">
	<p>
		<!-- © 2014 <a href="http://www.yunshipei.com" target="_blank">AllMobilize,
			Inc.</a> Licensed under <a href="http://opensource.org/licenses/MIT"
			target="_blank">MIT license</a>. by the AmazeUI Team. -->

		Copyright © 2018 YingHYingH. All rights reserved. 
	</p>
	</footer>
